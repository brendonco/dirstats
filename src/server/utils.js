...
const successFooter = "Project has been successfully compiled";

// `<div class="stats-success-footer">
...
function _formattedSuccessfulRun(stats) {
  ...
  const head = `Hash: ${stats.hash} Webpack version: ${stats.version}`;

  const dev = stats.isDev
    ? "Running dev-server does not necessarily represent accurate final assets size and performance metrics."
    : "";
